          ...
          <div class="row mt-5">
            <div class="col-md-8">
              <form method="post" action="{{url('/post-register')}}" enctype="multipart/form-data">
                ...
                /><br /><br />
                <div>
                  <input id="password" placeholder="Password" type="password" class="mx-5 my-2 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                  <br /><br />
                    @error('password')
                ...
                <input id="password" placeholder="Konfirmasi Password" type="password" class=" mx-5 my-2 @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">
              ...
              <div class="pict col-md-2 mt-5">
                ...
                <button type="submit" class="btnDaftar d-flex align-items-center  mx-0"
                >Daftar</button
                >
              </form>
            </div>
