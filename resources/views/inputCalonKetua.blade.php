...
<head>
  ...
  <link rel="stylesheet" href="{{url('css/user/inputCalonKetua.css')}}" />
        ...
        <div class="row mt-5">
          <div class="col-md-8">
            <form method="post" action="{{url('/register')}}">
              ...
              <input type="text" id="nomorUrut" name="nomorUrut" placeholder="Nomor Urut" class="mx-5 my-2" /><br /><br />
          ...
          <div class="pict col-md-2 mt-5">
            <img src="{{url('/images/download.jpg')}}" class="d-flex justify-content-center" />
